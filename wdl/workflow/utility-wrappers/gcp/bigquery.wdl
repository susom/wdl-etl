version development
#
# WDL wrapper for jBQ BigQuery API calls
#
import "structs.wdl"
...
task Query {
    ...
    command {
      jbq ${"--project_id=" + projectId} ${"--credentials=" + credentials} query ~{write_json(config)}
    }
...
task CreateTable {
    ...
    command {
      jbq ${"--project_id=" + projectId} ${"--credentials=" + credentials} create_table ~{write_json(config)}
    }
...
task CopyTable {
    ...
    command {
      jbq ${"--project_id=" + projectId} ${"--credentials=" + credentials} copy_table ~{write_json(config)}
    }
...
task CreateDataset {
    ...
    command {
      jbq ${"--project_id=" + projectId} ${"--credentials=" + credentials} create_dataset ~{write_json(config)}
    }
...
task DeleteDataset {
    ...
    command {
      jbq ${"--project_id=" + projectId} ${"--credentials=" + credentials} delete_dataset ~{write_json(config)}
    }
